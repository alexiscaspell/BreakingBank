...
class Category(Base):
    ...
    __table_args__ = (UniqueConstraint("group_id", "client_id", name="uq_category_group_client"),)
    ...
    icon_type: Mapped[str] = mapped_column(String(20), default="preset")  # preset | custom
    icon_key: Mapped[str | None] = mapped_column(String(50), nullable=True)
    icon_storage_key: Mapped[str | None] = mapped_column(String(255), nullable=True)
